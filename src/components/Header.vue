    ...
    <header class="min-w-screen min-h-screen flex justify-center items-center flex-col text-center">
        ...
        <section class="my-2 p-4">
            <a href="https://github.com/LehuyH" target="_blank">
                <svg class="inline-block m-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path
            ...
            <a href="#contact">
                <svg class="inline-block m-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24">
                    <path
                        d="M12 12.713l-11.985-9.713h23.971l-11.986 9.713zm-5.425-1.822l-6.575-5.329v12.501l6.575-7.172zm10.85 0l6.575 7.172v-12.501l-6.575 5.329zm-1.557 1.261l-3.868 3.135-3.868-3.135-8.11 8.848h23.956l-8.11-8.848z" />
                    </svg>
            </a>
            <a href="https://www.linkedin.com/in/lehuyh" target="_blank">
                <svg class="inline-block m-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path
